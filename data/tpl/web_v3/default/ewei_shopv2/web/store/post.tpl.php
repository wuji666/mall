...
<form <?php if( ce('store' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
  ...
  <div class="form-group">
        ...
        <label class="col-lg control-label must">店长 :</label>

        <div class="col-sm-9 col-xs-12">
            <p>
                <select id="uid" name="uid" onChange="selectCity();" class="select form-control select-group" style="width:123px;display:inline;">
  ...
  <div class="form-group">
        <label class="col-lg control-label must">营养师 :</label>
        <div class="col-sm-9 col-xs-12">
            <p>
                <select id="yid" name="yid" onChange="selectCity();" class="select form-control select-group" style="width:123px;display:inline;">
                    <?php  if(is_array($lists2)) { foreach($lists2 as $row) { ?>
                    <option value="<?php  echo $row['uid'];?>" ><?php  echo $row['username'];?></option>
                    <?php  } } ?>
                </select>
            </p>
