define(['jquery.ui', '../../../../static/js/web/goods_selector.js'], function (ui, gSelector) {
    ...
    modal.initEditor = function (scroll) {
        ...
        var categorySelector = $("#diy-editor .job-selector").length;
        if (categorySelector > 0) {
            var _this = $("#diy-editor .job-selector");
            var url = biz.url('goods/job/query', null, modal.merch);
            if (_this.data('goodstype') == 1) {
                url = biz.url('creditshop/job/query', null, modal.merch)
            }
        ...
        var merchCategorySelector = $("#diy-editor .merch-job-selector").length;
        if (merchCategorySelector) {
            var _this = $("#diy-editor .merch-job-selector");
            var url = biz.url('merch/job/query', null, modal.merch);
