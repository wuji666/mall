...
class Detail_EweiShopV2Page extends MobilePage 
{
	public function main() 
	{
		...
		$goodid = pdo_get('ewei_shop_purchase',array('good_id'=>$id));
		$goods = pdo_fetch('select * from ' . tablename('ewei_shop_goods') . ' where id=:id and uniacid=:uniacid limit 1', array(':id' => $goodid['good_id'], ':uniacid' => $_W['uniacid']));
		if ($goods['isverify'] == 2) 
		{
			unset($gifts);
		}
